...
explored the possibility of having an infinite resolution canvas. However, rather than a general painting program 
this work is focused on creating an interface builder for developers.}
...
rendered to yield a rasterized version of the stroke. \modified{This rasterization happens at the resolution of the current window. Therefore
...
this could be ameliorated by switching to double-precision. \modified{This significantly exceeds the limits
imposed by existing vector graphics software such as Adobe Illustrator, which has a maximum zoom ratio
of 64:1.  Furthermore, our ability to make paint strokes of smooth gradients in a flat vector representation (see Figure~\ref{fig:teaser}) is unique.}
...
longer for the reasons described. \modified{For example, the first ten strokes in both cases take about 2 seconds
to render, while the last ten strokes take about 20 seconds in the non-zooming case and 7 seconds in the zooming case.}
