...
\begin{figure*}
    ...
    \caption{A drawing by an artist that took 30 minutes. 9030 triangles. Approximately 70 strokes.}
    \label{fig:face}
\end{figure*}

\begin{figure*}
    \centering
        \fbox{\includegraphics[width=0.3\textwidth]{images/stop12}}
        \fbox{\includegraphics[width=0.3\textwidth]{images/stop22}}
        \fbox{\includegraphics[width=0.3\textwidth]{images/stop32}}
