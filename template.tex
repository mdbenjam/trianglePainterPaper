...
\teaser{
  ...
  \caption{A vector painting made in TrianglePaint that exhibits smooth gradients painted by soft brushes, as well as infinitely sharp boundaries painted by hard brushes, together in a single flat representation.  The triangle mesh is shown in the middle, and the right image is zoomed in on the bottom of the letter B, to show the sharp boundaries and smooth gradients in detail.}
  \label{fig:teaser}
}
...
\begin{figure}
    \centering
        \includegraphics[width=.2\textwidth]{images/stroke_triangulation/hardrendered}
        \includegraphics[width=.2\textwidth]{images/stroke_triangulation/softrendered}
        
        \includegraphics[width=.2\textwidth]{images/stroke_triangulation/hardpruned}
        \includegraphics[width=.2\textwidth]{images/stroke_triangulation/softpruned}
        
        \includegraphics[width=.2\textwidth]{images/stroke_triangulation/hardmesh}
        \includegraphics[width=.2\textwidth]{images/stroke_triangulation/softmesh}
...
\begin{figure*}
    \centering
        \includegraphics[width=.32\textwidth]{images/composite1new}
        \includegraphics[width=.32\textwidth]{images/composite2new}
        \includegraphics[width=.32\textwidth]{images/composite3new}
    \caption{Left: A blue stroke is composited over a red stroke. Point A is covered
             by the the blue stroke and point B is on top of the red stroke. Middle:
             New color arcs are determined. Both of A's color arcs are composited
             with the blue stroke which turns red to purple and transparent to blue. Similarly
