...
all triangles connecting the inner and outer strokes a linear gradient (see Figure~\ref{XXX}).
...
Paintings made with TrianglePainter can be seen in Figures~\ref{fig:face} and \ref{fig:boxes}.  Here we first consider how the complexity of the algorithm grows both in time and geometry.
